...
public class Exito extends JDialog {
    ...
    public Exito(String mensagge) {
        ...
        {
            JLabel lblNewLabel_1 = new JLabel(mensagge);
            lblNewLabel_1.setForeground(new Color(12, 138, 199));
            lblNewLabel_1.setFont(new Font("Arial", Font.BOLD, 18));
            lblNewLabel_1.setBounds(27, 122, 322, 21);
            lblNewLabel_1.setHorizontalAlignment((int) CENTER_ALIGNMENT);
            ...
            getContentPane().add(buttonPane, BorderLayout.SOUTH);
            {
                ...
                okButton.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (mensagge.equals("Datos guardados satisfactoriamente")) {
